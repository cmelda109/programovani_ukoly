...
try:
    ...
    with open("vstup.csv", encoding="utf-8") as f,\
        ...
        for row in reader:      
            ...
            if radky_tyden % 7 == 1:                                   # prvni radek ze sedmi se ulozi do promenne vytiskni    
                vytiskni = row[0:-1]

            if radky_tyden  == 7:                                      # pokud narazi na sedmy radek vypise sedmidenni prumer    
        ...
        if (radky_tyden-1) % 7 != 6:                                           # pokud se na konci seznamu nachází méně, jak 7 řádků, vypočítá se průměr pouze z nich
    ...
    with open("vstup.csv", encoding="utf-8") as f,\
        ...
        for row in reader:                                              
            ...
            if rok == 0: 
                vytiskni2 = row[0:-1] 
                prutok_max_radek = row                              # Určení min a max podle prvního řádku
